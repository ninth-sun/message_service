...
public class MessageController {
    ...
    public CommonResponse sendMessageByTicketId(@RequestParam("ticket_id") String ticketId) {
        messageService.send(ticketId);
        return CommonResponse.success();
    }

    @PostMapping(value = "/send/custom")
    public CommonResponse sendMessage(@RequestBody MessageObject messageObject) {
